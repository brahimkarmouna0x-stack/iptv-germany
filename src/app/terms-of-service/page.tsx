...
export const metadata: Metadata = buildMetadata({
  title: "Algemene voorwaarden voor het IPTV-abonnement | IPTV Smarter",
  description:
    "Lees de algemene voorwaarden van IPTV Smarter voor uw IPTV-abonnement. Duidelijke regels over gebruik, betaling en garantie.",
        ...
        <div className="glass rounded-2xl p-5 sm:p-8 lg:p-12 space-y-10 sm:space-y-12 animate-slide-up">
          <section>
            ...
            <p className="text-blanc-300 leading-relaxed">
              Door IPTV Smarter te bezoeken of te gebruiken, accepteert u deze algemene voorwaarden. Als u niet alle voorwaarden accepteert, mag u de dienst niet gebruiken.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-blanc-300 leading-relaxed">
              IPTV Smarter biedt een IPTV-abonnementsdienst waarmee gebruikers toegang krijgen tot live tv-zenders en content-on-demand via internet. De beschikbaarheid van content kan per regio verschillen en kan veranderen.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-blanc-300 leading-relaxed">
              IPTV Smarter is niet aansprakelijk voor indirecte, incidentele, speciale of gevolgschades voortvloeiend uit het gebruik of het onvermogen om de dienst te gebruiken.
            </p>
          </section>
