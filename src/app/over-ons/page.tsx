...
export const metadata: Metadata = buildMetadata({
  title: "Over ons | IPTV Smarter — De IPTV-aanbieder van Nederland",
  description:
    "Ontdek IPTV Smarter, de meest betrouwbare premium IPTV-aanbieder van Nederland. Wij bieden 24/7 ondersteuning en 99,9% beschikbaarheid.",
  path: "/over-ons",
});
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(breadcrumbSchema([
            ...
            { name: "Over ons", url: "https://iptvsmarter.nl/over-ons" },
          ])),
        }}
      />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 max-w-4xl text-blanc-50">
          <div className="prose prose-invert lg:prose-lg mx-auto prose-a:text-france-400 hover:prose-a:text-france-300">
            <h2>Wie zijn wij</h2>
            <p>
              Bij <strong>IPTV Smarter</strong> zetten wij ons in om de ultieme tv-ervaring te bieden aan Nederlandstaligen die in Nederland wonen.
