...
export const metadata: Metadata = buildMetadata({
  title: "Privacybeleid — Bescherming van uw gegevens | IPTV Smarter",
  description:
    "Lees het privacybeleid van IPTV Smarter: welke gegevens we verzamelen, hoe we ze gebruiken en hoe we uw privacy beschermen conform de AVG.",
  path: "/privacy-policy",
  noIndex: false,
});
        ...
        <div className="glass rounded-2xl p-5 sm:p-8 lg:p-12 space-y-10 sm:space-y-12 animate-slide-up">
          <section>
            ...
            <p className="text-blanc-300 leading-relaxed">
              Bij IPTV Smarter nemen wij uw privacy serieus. Dit privacybeleid legt uit hoe wij uw persoonlijke gegevens verzamelen, gebruiken en beschermen wanneer u onze IPTV-diensten gebruikt. Door IPTV Smarter te gebruiken, accepteert u de voorwaarden van dit document.
            </p>
          </section>
