...
export const AUTHORITY_SECTIONS: Record<string, AuthoritySectionsContent> = {
  ...
  home: {
    ...
    howto: {
      ...
      schemaDescription:
        "Stap-voor-stap gids om in minder dan 5 minuten te beginnen met een IPTV-abonnement van IPTV Smarter.",
      totalTime: "PT5M",
      steps: [
    ...
    reviews: {
      ...
      titleAccent: "IPTV Smarter",
      productName: "IPTV Smarter — Premium IPTV-abonnement",
      productDescription:
    ...
    local: {
      ...
      intro:
        "Waar u ook woont — van de Randstad tot de provincie — met IPTV Smarter kijkt u via uw eigen internetverbinding. Geen monteur, geen schotel, geen wachttijd.",
      cities: NL_CITIES,
  ...
  "iptv-abonnement": {
    seo: {
      ...
      titleAccent: "Nederland",
      intro:
        "Een IPTV-abonnement geeft u onbeperkte toegang tot live TV, sport, films en series via internet. Bij IPTV Smarter bevat elk abonnement alle zenders — het enige verschil is het aantal apparaten dat tegelijk wordt gebruikt.",
      blocks: [
        {
        ...
        },
        {
          ...
          body:
            "Waar een traditioneel TV-pakket snel 40 tot 60 euro per maand kost, begint een premium IPTV-abonnement bij IPTV Smarter veel lager — met meer zenders en zonder lang contract. U bespaart elke maand zonder aan kwaliteit in te boeten.",
        },
      ],
      links: [
    ...
    howto: {
      ...
      schemaDescription:
        "Stap-voor-stap gids om een IPTV-abonnement van IPTV Smarter te bestellen en te activeren.",
      totalTime: "PT5M",
      steps: [
    ...
    reviews: {
      ...
      titleAccent: "IPTV-abonnement",
      productName: "IPTV Smarter — IPTV-abonnement Nederland",
      productDescription:
    ...
    local: {
      ...
      titleAccent: "Nederland",
      intro:
        "Een IPTV-abonnement van IPTV Smarter is niet gebonden aan een regio. Zolang u internet heeft, kijkt u — thuis, op de camping of in een vakantiewoning.",
      cities: NL_CITIES,
      provinces: NL_PROVINCES,
      outro:
  ...
  "iptv-aanbieder": {
    seo: {
      ...
      blocks: [
        ...
        },
        {
          ...
          body:
            "Onderbrekingen komen meestal door overbelaste of te ver weg geplaatste servers. IPTV Smarter gebruikt krachtige servers met load balancing dicht bij Nederland, zodat een vloeiende 4K-stream behouden blijft, zelfs tijdens grote sportavonden.",
        },
        {
    ...
    reviews: {
      ...
      titleAccent: "IPTV-aanbieder",
      productName: "IPTV Smarter — Betrouwbare IPTV-aanbieder Nederland",
      productDescription:
  ...
  "iptv-kopen": {
    seo: {
      ...
      intro:
        "Een IPTV kopen is eenvoudig, maar een veilige aankoop vraagt aandacht. Controleer de betaalmogelijkheden, de proefperiode en duidelijke voorwaarden. Bij IPTV Smarter bestelt u veilig met iDEAL en kijkt u binnen enkele minuten.",
      blocks: [
        {
    ...
    howto: {
      ...
      titleAccent: "IPTV",
      intro:
        "Een IPTV kopen bij IPTV Smarter is veilig en snel. Volg deze vier stappen en u kijkt vandaag nog.",
    ...
    reviews: {
      ...
      productName: "IPTV Smarter — IPTV kopen Nederland",
      productDescription:
  ...
  "iptv-nederland": {
    seo: {
      ...
      titleAccent: "Nederland",
      intro:
        "IPTV Smarter is ontworpen voor de Nederlandse markt: een ruime keuze aan Nederlandse zenders (publiek, commercieel, sport) en internationale zenders, voetbal en grote competities, plus duizenden internationale zenders. Servers dicht bij Nederland zorgen voor een vloeiende stream.",
      blocks: [
        {
    ...
    reviews: {
      ...
      titleAccent: "Nederland",
      productName: "IPTV Smarter — IPTV Nederland",
      productDescription:
    ...
    local: {
      ...
      titleAccent: "Nederland",
      intro:
        "Of u nu in de Randstad woont of in een grensdorp — IPTV Smarter levert dezelfde kwaliteit en dezelfde zenders in elke provincie en gemeente.",
      cities: NL_CITIES,
      provinces: NL_PROVINCES,
      outro:
  ...
  "iptv-smarters-pro": {
      ...
      blocks: [
        {
          ...
          body:
            "IPTV Smarters Pro is een gratis IPTV-speler die uw IPTV Smarter-abonnement afspeelt. De app ondersteunt Xtream Codes en M3U-playlists, toont een compleet programmagids en onthoudt waar u was gebleven bij uw films en series.",
        },
        {
    ...
    reviews: {
      ...
      title: "De beoordelingen over",
      titleAccent: "IPTV Smarters Pro",
      productName: "IPTV Smarter met IPTV Smarters Pro",
      productDescription:
      ...
      items: [
        ...
        { author: "Mei Lin", location: "Utrecht", date: "2026-03-28", rating: 4, body: "Fijne app en duidelijke gids van IPTV Smarter. De EPG laadt soms wat, daarna is alles perfect." },
