...
const aanbieder: SixteenSectionContent = {
  ...
  meta: {
    ...
    description: "Op zoek naar de beste IPTV-aanbieder van Nederland? Vergelijk alle aanbieders, prijzen en diensten. IPTV Smarter scoort 4,9/5. Ontdek waarom.",
  ...
  whyUs: {
    ...
    reasons: [
      ...
      { title: "IPTV Aanbieder: alles inbegrepen, geen themapakketten", desc: "Bij veel aanbieders betaalt u extra voor sport, films of 4K. Bij IPTV Smarter zit alles in elk abonnement. Eén vast bedrag voor het volledige aanbod." },
    ],
  },
  ...
  how: {
    ...
    steps: [
      { step: "01", title: "IPTV Aanbieder: vergelijk en kies", desc: "Bekijk onze abonnementen en vergelijk ze met andere aanbieders. Kijk naar de prijs, het aanbod, de klantenservice en de stabiliteit. U zult zien dat IPTV Smarter op alle vlakken beter is." },
  ...
  comparison: {
    ...
    title: "IPTV Smarter versus andere IPTV-aanbieders in Nederland",
  ...
  testimonials: {
    ...
    subtitle: "Lees wat onze klanten zeggen over IPTV Smarter als IPTV-aanbieder.",
  },
    ...
    faqs: [
      {
        ...
        answer: "Op basis van onafhankelijke beoordelingen, serverkwaliteit, klantenservice en prijs-kwaliteitverhouding wordt IPTV Smarter beschouwd als de beste IPTV-aanbieder van Nederland. Met een Google-beoordeling van 4,9/5 en eigen servers in de buurt van Nederland, scoren we beter dan alle andere aanbieders."
      },
      {
      ...
      {
        question: "Biedt IPTV Smarter een gratis proefperiode aan?",
      ...
      {
        question: "Kan ik mijn abonnement bij IPTV Smarter wijzigen?",
      ...
      },
      {
        ...
        answer: "Bij IPTV Smarter wordt uw account binnen 5 minuten geactiveerd. U ontvangt direct uw M3U-link en Xtream Codes via e-mail en WhatsApp. Dat is aanzienlijk sneller dan het gemiddelde van 1 tot 48 uur bij andere IPTV-aanbieders."
      },
      {
  ...
  finalCta: {
    ...
    description: "Waarom genoegen nemen met minder? Kies IPTV Smarter en ervaar het verschil. Beoordeling van 4,9/5, schone servers en Nederlandstalige klantenservice 24/7.",
  },
};
